...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-collapse-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-collapse-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install r-collapse
```
...
It is possible to list all of the versions of `r-collapse` available on your platform:
...
```
pixi search r-collapse --channel conda-forge
```
